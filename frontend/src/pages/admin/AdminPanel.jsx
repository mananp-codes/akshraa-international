...
import { FiUsers, FiPackage, FiShoppingBag, FiDollarSign, FiCheck, FiX, FiToggleLeft, FiToggleRight, FiPlus, FiEdit2, FiTrash2 } from 'react-icons/fi';
...
const TABS = ['Overview', 'Users', 'Pending Sellers', 'Products', 'Orders'];
...
const AdminPanel = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [statsRes, usersRes, pendingRes, ordersRes, productsRes] = await Promise.all([
          getAdminStats(),
          getAllUsers(),
          getPendingSellers(),
          getAllOrders(),
        ...
        {activeTab === 'Products' && (
          <div className="card overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between">
              <h3 className="font-semibold text-lg">All Products ({products.length})</h3>
              <Link to="/seller/products/new" className="btn-primary flex items-center gap-2 text-sm py-2 px-4">
                <FiPlus /> Add Product
              </Link>
            </div>
                      ...
                      <tr key={product._id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button onClick={() => handleDeleteProduct(product._id, product.name)} className="p-1.5 text-red-500 hover:bg-red-50 rounded-lg">
                              <FiTrash2 />
                            </button>
                          </div>
                        </td>
